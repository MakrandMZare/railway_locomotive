...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center">
        ...
        <tr>
            <td>
                <asp:Panel runat="server" ID="p1" Width="100%">
                  ...
                  Font-Size="14" Width="990px"   CellPadding="0" CellSpacing="0" >
                    ...
                    <table cellspacing="1" cellpadding="0" width="990">
                        ...
                        <tr>
                              <td rowspan="1" colspan="1">
                             <br /> 
                             <asp:Label runat="server" ID="lbl10" Font-Bold="True" Font-Size="15pt"></asp:Label>
         ...
         <asp:Label runat="server" ID="lbl9" Font-Bold="True" Font-Size="15pt"></asp:Label>
    ...
    <asp:Panel runat="server" ID="Page2">
        ...
        <br />
          <asp:Label runat="server" ID="lbl8"  Font-Bold="True" Font-Size="14"></asp:Label>
     ...
     <%--<FooterTemplate>
        ...
        <br />
          <asp:Label runat="server" ID="lbl7" Visible="true" Font-Bold="True" Font-Size="14"></asp:Label>
        ...
        <table>
            <tr>
                <td>
                  ...
                  <asp:Panel ID="panel_gv_temparary_repair" runat="server" Visible="true">
