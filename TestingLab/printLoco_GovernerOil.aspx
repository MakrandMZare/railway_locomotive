<%@ Page Language="C#" MasterPageFile="~/Loco/MasterPage.master" AutoEventWireup="true" CodeFile="printLoco_GovernerOil.aspx.cs" Inherits="TestingLab_printLoco_GovernerOil" Title="Untitled Page" %>
        ...
        <tr>
            <td>
                <asp:Panel runat="server" ID="p1">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:GridView ID="gv1" runat="Server" AutoGenerateColumns="false" DataKeyNames="Id_GovernerOil"
