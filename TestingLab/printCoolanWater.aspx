<%@ Page Language="C#" MasterPageFile="~/Loco/MasterPage.master" AutoEventWireup="true" CodeFile="printCoolanWater.aspx.cs" Inherits="TestingLab_printCoolanWater" Title="Untitled Page" %>
        ...
        <tr>
            <td>
                <asp:Panel runat="server" ID="p1">
                    &nbsp;&nbsp;&nbsp;
                    <asp:GridView ID="gv1" runat="Server" AutoGenerateColumns="false" DataKeyNames="coolantwater_id"
