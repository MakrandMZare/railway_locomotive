<%@ Page Language="C#" MasterPageFile="~/Loco/MasterPage.master" AutoEventWireup="true" CodeFile="rly.aspx.cs" Inherits="rly" Title="Untitled Page" EnableEventValidation ="false"  Theme="SkinFile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 ID="btnadd" runat="server" OnClientClick="return ShowPanel();" OnClick="btnadd_Click" Text="Add" Width="78px" ValidationGroup="a" /></td>
                        </tr>
                    </table>
                </div>
            </td>
 ...
 runat="server" AutoGenerateColumns="False" >
    ...
    <ItemTemplate>
    <asp:Label runat="server" ID="l1" Text='<%#Eval("s_name")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    
      <asp:TemplateField headertext="FULL NAME">
    <ItemTemplate>
    <asp:Label runat="server" ID="l2" Text='<%#Eval("full_name")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:ImageButton ID="lbtnupdate" runat="server" Text="Update" ImageUrl="~/Images/Edit-icon.png" PostBackUrl='<%# "~/Master/rly.aspx?id="+ Eval("id_rly") + "&action=update" %>' />
    <asp:ImageButton ID="lbtnDelete" runat="server" Text="Delete" ImageUrl="~/Images/Delete-icon.png" PostBackUrl='<%# "~/Master/rly.aspx?id="+ Eval("id_rly") + "&action=delete" %>'/>
    </ItemTemplate>
    </asp:TemplateField>
                    </Columns>
                </asp:GridView>
