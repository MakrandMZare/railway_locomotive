<%@ Page Language="C#" MasterPageFile="~/Loco/MasterPage.master" AutoEventWireup="true" CodeFile="Assembly_NonStock_Master.aspx.cs" Inherits="Master_Assembly_NonStock_Master" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table align="center">
        ...
        <tr>
            <td colspan="10">
                <asp:GridView runat="server" ID="gv1" AutoGenerateColumns="false" DataKeyNames="Id_NonStock" EmptyDataText="Non Item Found...!"
