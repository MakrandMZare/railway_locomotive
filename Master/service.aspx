<%@ Page Language="C#" MasterPageFile="~/Loco/MasterPage.master" AutoEventWireup="true" CodeFile="service.aspx.cs" Inherits="service" Title="Untitled Page" EnableEventValidation ="false" Theme="SkinFile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 ID="txtservice" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtservice"
 ...
 ID="btnadd" runat="server" OnClick="btnadd_Click" Text="Add" Width="73px" ValidationGroup="a" /></td>
                        </tr>
                        <tr>
                            <td>
 ...
 ID="GridView1" runat="server" AutoGenerateColumns="False" >
    ...
    <ItemTemplate>
    <asp:Label runat="server" ID="l1" Text='<%#Eval("service")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:ImageButton ID="lbtnupdate" runat="server" Text="Update" ImageUrl="~/Images/Edit-icon.png" PostBackUrl='<%# "~/Master/service.aspx?id="+ Eval("id_ser") + "&action=update" %>' />
    <asp:ImageButton ID="lbtnDelete" runat="server" Text="Delete" ImageUrl="~/Images/Delete-icon.png" PostBackUrl='<%# "~/Master/service.aspx?id="+ Eval("id_ser") + "&action=delete" %>'/>
    </ItemTemplate>
    </asp:TemplateField>
